...
const data = [
  ...
  },
  {
    ...
    date: "April 13, 2022",
    firstParagraph: `Congratulation to Chris Peralta for being student of the year! He will be receiving $1,000,000!!! `,
...
function articleMaker(articleObj) {
  ...
  articleDiv.appendChild(articleParagraphOne);
  articleDiv.appendChild(articleParagraphTwo);
  articleDiv.appendChild(articleParagraphThree);
